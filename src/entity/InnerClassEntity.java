...
//                }
    ...
    public void createMethod(PsiElementFactory mFactory, String method, PsiClass cla) {
...
//                    mClass.add(mFactory.createMethodFromText(method, mClass));
                    String method = "@SerializedName(\"".concat(field1.getKey()).concat("\") \t\t").concat("public abstract ")
                            .concat(typeStr).concat(" ").concat(
...
//                String methodset = "public void  set".concat(captureName(field)).concat("( ").concat(typeStr).concat(" ").concat(arg).concat(") {   ");
